...
#This script will compile and install the dependencies build with support for unistream ubuntu or centos or debian
...
installLibs() {
  ...
  . /etc/os-release
  case "$ID" in
    ubuntu | linuxmint | debian ) installAptLibs ;;
    * )                  installYumLibs ;;
  esac
}
