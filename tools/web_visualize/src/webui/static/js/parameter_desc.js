window.PARAM_DESC = {}
PARAM_DESC["unistream::DataSource"] = {
    custom_params: {
...
PARAM_DESC["unistream::Inferencer"] = {
    custom_params: {
        model_path: "Required. <br> Desc: The path of the offline model.",
        preproc: "Required. <br> Desc: The class name for preprocess. Parameters related to postprocessing including name and use_cpu. The class specified by this name must inherit from class unistream::Preproc",
        postproc: "Required. <br> Desc: The class name for postprocess. Parameters related to postprocessing including name and threshold. The class specified by this name must inherit from class unistream::Postproc.",
        ...
        filter: "Optional. <br> Default value: [] <br> Desc: Parameters related to filter including name and categories. The class name for custom object filter must inherit from class unistream::ObjectFilterVideo.. ",
